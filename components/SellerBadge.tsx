  ...
  return (
    <View style={styles.card}>
      <View style={styles.row}>
        <Image source={{ uri: seller.avatarUrl || 'https://via.placeholder.com/120' }} style={styles.avatar} />
      ...
      <TouchableOpacity style={styles.button} onPress={() => router.push(`/seller/${seller.id}`)}>
