  ...
  const handleSubmit = async () => {
    try {
      ...
      await createProduct({
        ...
        discountPercentage: previousPrice
          ? Math.max(
              0,
              Math.round(
                ((Number(previousPrice) - Number(currentPrice)) /
      ...
      setNotification({
        type: "error",
        message:
          error instanceof Error ? error.message : "Unable to post product",
      });
    }
  };
    ...
    >
      ...
      >
        ...
        <Text style={styles.subtitle}>
          Share product details for local buyers in your city.
        </Text>
        {user ? null : (
          <Text style={styles.infoText}>
            Sign in first from the Account tab to post products.
          </Text>
        )}
          ...
          <View style={styles.gridRow}>
            {categories.map((item) => (
              <TouchableOpacity
                ...
                style={[
                  styles.optionButton,
                  category === item && styles.optionButtonActive,
                ]}
          ...
          <View style={styles.gridRow}>
            {conditions.map((item) => (
              <TouchableOpacity
                ...
                style={[
                  styles.optionButton,
                  condition === item && styles.optionButtonActive,
                ]}
