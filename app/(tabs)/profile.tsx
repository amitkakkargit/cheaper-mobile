  ...
  return (
    ...
    >
      <ScrollView contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
        ...
        <Text style={styles.subtitle}>Sign in and manage your buyer or seller profile.</Text>

        {user ? (
          <View style={styles.card}>
            <Text style={styles.label}>Signed in as</Text>
            <Text style={styles.value}>{user.name ?? user.email ?? user.phone ?? 'Anonymous'}</Text>
          ...
          <View style={styles.card}>
            ...
            <TextInput
              ...
              placeholder={mode === 'phone' ? '+919876543210' : 'you@example.com'}
              placeholderTextColor="#94a3b8"
              autoCapitalize="none"
